...
@section('content')
<div class="teacher-dashboard-container max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
    {{-- Welcome header --}}
    <div class="mb-6 lg:mb-8">
        <h1 class="teacher-dashboard-welcome-title text-xl lg:text-2xl">
    ...
    {{-- Stat cards --}}
    <div class="teacher-dashboard-stats grid grid-cols-2 lg:grid-cols-4 gap-4 lg:gap-6 mb-6 lg:mb-8">
        <div class="teacher-dashboard-stat-card bg-white rounded-lg shadow-sm border border-gray-100 p-4 lg:p-6 flex items-start gap-4">
            ...
            <div class="teacher-dashboard-course-row">
                <div class="teacher-dashboard-course-row-inner">
                    ...
                    <a href="{{ route('teacher.courses.show', $course->id) }}" class="teacher-dashboard-course-thumb">
                        ...
                        @else
                            <div class="teacher-dashboard-course-thumb-placeholder">
                                <svg fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M12 6.253v13m0-13C10.832 5.477 9.246 5 7.5 5S4.168 5.477 3 6.253v13C4.168 18.477 5.754 18 7.5 18s3.332.477 4.5 1.253m0-13C13.168 5.477 14.754 5 16.5 5c1.747 0 3.332.477 4.5 1.253v13C19.832 18.477 18.247 18 16.5 18c-1.746 0-3.332.477-4.5 1.253"></path></svg>
                            </div>
                        @endif
                    </a>
