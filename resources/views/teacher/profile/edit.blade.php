    ...
    <div class="bg-white rounded-lg shadow p-6">
        ...
        <form action="{{ route('teacher.profile.update') }}" method="POST" enctype="multipart/form-data">
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                ...
                <div class="md:col-span-2">
                    ...
                    <textarea name="bio" rows="4"
                              class="w-full px-3 py-2 border rounded">{{ old('bio', $profile->bio ?? $user->bio) }}</textarea>
                ...
                <div class="md:col-span-2">
                    ...
                    <textarea name="qualifications" rows="3"
                              class="w-full px-3 py-2 border rounded">{{ old('qualifications', $profile->qualifications ?? '') }}</textarea>
                ...
                <div class="md:col-span-2">
                    ...
                    <input type="text" name="specializations" value="{{ old('specializations', $profile->specializations ?? '') }}"
                           class="w-full px-3 py-2 border rounded" placeholder="e.g., Mathematics, Physics">
            ...
            <div class="mt-6 flex gap-4">
                ...
                <a href="{{ route('teacher.profile.show') }}" class="bg-gray-300 text-gray-700 px-6 py-2 rounded hover:bg-gray-400">
                    Cancel
                </a>
            </div>
        </form>
