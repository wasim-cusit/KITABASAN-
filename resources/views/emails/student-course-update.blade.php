...
<body>
    <div class="container">
        ...
        <div class="content">
            ...
            <p>A course you're enrolled in has been updated.</p>
            <div class="box">
                <strong>Course:</strong> {{ $course->title ?? 'N/A' }}<br>
                <strong>Change:</strong> {{ $changeSummary }}
            </div>
            <p>View the course: <a href="{{ route('student.learning.index', $course->id) }}">Go to course</a></p>
        </div>
        <div class="footer">
            <p>This is an automated message from {{ config('app.name', 'KITAB ASAN') }}. You can turn off these emails in Settings.</p>
        </div>
    </div>
</body>
</html>
