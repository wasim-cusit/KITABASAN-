...
<div class="bg-white rounded-lg shadow h-[700px] flex flex-col"
     ...
     x-data="{
         ...
         loading: false,
         messageInput: '',
         chatbotUrl: '{{ route('student.chatbot.send') }}',
        ...
        <div class="flex items-center justify-between">
            <div class="flex items-center gap-3">
                ...
                <div class="leading-tight">
                    ...
                    <p class="text-xs text-blue-100">Ask me anything about your learning journey</p>
                </div>
            </div>
        </div>
    </div>
    ...
    <!-- Messages Area -->
    <div class="flex-1 min-h-0 overflow-y-auto p-4 space-y-4 bg-gray-50" id="chatbot-messages">
        <!-- Welcome Message -->
        <template x-if="messages.length === 0">
            <div class="flex flex-col items-center justify-center h-full text-center p-4">
                ...
                <p class="text-gray-600 text-sm mb-4">I'm your learning assistant. Ask me anything about courses, enrollments, progress, or learning support!</p>
                <div class="flex flex-wrap gap-2 justify-center">
                    <button @click="sendQuickMessage('How do I enroll in a course?')"
                        class="text-xs bg-blue-50 text-blue-600 px-3 py-1 rounded-full hover:bg-blue-100 transition">
                        How to enroll?
                    </button>
                    <button @click="sendQuickMessage('How do I track my progress?')"
                        class="text-xs bg-blue-50 text-blue-600 px-3 py-1 rounded-full hover:bg-blue-100 transition">
                        Track progress
                    </button>
                    <button @click="sendQuickMessage('Are there free courses available?')"
                        class="text-xs bg-blue-50 text-blue-600 px-3 py-1 rounded-full hover:bg-blue-100 transition">
                        Free courses?
                    </button>
                </div>
