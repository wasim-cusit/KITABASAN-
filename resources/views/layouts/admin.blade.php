...
<head>
    ...
    <title>@yield('title', 'Admin - KITAB ASAN')</title>
            ...
            <div class="p-4">
                <div class="mb-8">
                    ...
                    <div class="pb-4 border-b border-gray-700">
                        <!-- Logo -->
                        <a href="{{ route('admin.dashboard') }}" class="flex justify-center mb-3 hover:opacity-80 transition">
                        ...
                        <div class="text-center">
                            ...
                            <p class="text-gray-400 text-xs mt-1">Admin</p>
                        </div>
                    </div>
                </div>
                ...
                <nav class="space-y-2">
                    ...
                    <a href="{{ route('admin.teachers.index') }}" class="flex items-center space-x-2 px-4 py-2 rounded-lg hover:bg-gray-700 {{ request()->routeIs('admin.teachers.*') ? 'bg-gray-700' : '' }}">
                    ...
                    <div class="relative" x-data="{ open: false }" @click.away="open = false">
                        ...
                        <div x-show="open"
                            ...
                            <div class="flex border-t border-gray-100 py-1">
                                <a href="{{ route('admin.profile.edit') }}" class="flex-1 flex items-center justify-center space-x-1.5 px-4 py-3 mx-1 my-1 text-sm text-gray-700 hover:bg-gray-50 transition-colors duration-150 border-r border-gray-200 rounded-lg">
