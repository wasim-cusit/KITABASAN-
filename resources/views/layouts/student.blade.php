        ...
        <aside :class="sidebarOpen ? 'translate-x-0' : '-translate-x-full'"
            ...
            <div class="p-4">
                ...
                <nav class="space-y-2">
                    ...
                    <a href="{{ route('student.courses.my') }}" class="flex items-center space-x-2 px-4 py-2 rounded-lg hover:bg-gray-700 {{ request()->routeIs('student.courses.my') ? 'bg-gray-700' : '' }}">
                    ...
                    <a href="{{ route('student.courses.index') }}" class="flex items-center space-x-2 px-4 py-2 rounded-lg hover:bg-gray-700 {{ request()->routeIs('student.courses.index') || request()->routeIs('student.courses.show') ? 'bg-gray-700' : '' }}">
