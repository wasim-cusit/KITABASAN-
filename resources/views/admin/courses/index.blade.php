...
<div class="bg-white rounded-lg shadow p-6">
    ...
    <!-- Filters -->
    <form method="GET" action="{{ route('admin.courses.index') }}" class="mb-6 grid grid-cols-1 md:grid-cols-4 gap-4">
            ...
            <tbody class="bg-white divide-y divide-gray-200">
                @forelse($courses as $course)
                    <tr>
                        <td class="px-6 py-4">
                            <div class="flex items-center">
                                @if($course->cover_image)
                                    <img src="{{ Storage::url($course->cover_image) }}" alt="{{ $course->title }}" class="h-12 w-12 rounded object-cover mr-3">
                                @endif
                                <div>
                        ...
                        <td class="px-6 py-4 whitespace-nowrap text-sm text-gray-500">{{ $course->teacher->name ?? 'N/A' }}</td>
                        ...
                        <td class="px-6 py-4 whitespace-nowrap text-sm font-medium">
                            <a href="{{ route('admin.courses.show', $course->id) }}" class="text-blue-600 hover:text-blue-900 mr-3">View</a>
