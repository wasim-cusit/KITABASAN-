...
<div id="public-chatbot-container" class="fixed bottom-4 right-4 md:bottom-6 md:right-6 z-50" x-data="{
        open: false,
        messages: [],
        loading: false,
        messageInput: '',
    ...
    <button @click="open = !open"
        ...
        :class="{ 'scale-95': open }" aria-label="Open Chatbot">
        ...
        <span
            ...
            x-show="messages.length > 0 && !open" style="display: none;">1</span>
    </button>
    ...
    <div x-show="open" x-transition:enter="transition ease-out duration-300"
        ...
        style="display: none; z-index: 9999;" @click.away="open = false">
        ...
        <div class="flex-1 overflow-y-auto p-4 space-y-4 bg-gray-50" id="chatbot-messages">
            ...
            <template x-if="messages.length === 0">
                <div class="flex flex-col items-center justify-center h-full text-center p-4">
                    ...
                    <p class="text-gray-600 text-sm mb-4">I'm your Kitabasan assistant. Ask me anything about our
                        platform, courses, enrollment, or support!</p>
                    <div class="flex flex-wrap gap-2 justify-center">
                        <button @click="sendQuickMessage('What is Kitabasan?')"
                            class="text-xs bg-blue-50 text-blue-600 px-3 py-1 rounded-full hover:bg-blue-100 transition">
                            What is Kitabasan?
                        </button>
                        <button @click="sendQuickMessage('How do I enroll?')"
                            class="text-xs bg-blue-50 text-blue-600 px-3 py-1 rounded-full hover:bg-blue-100 transition">
                            How do I enroll?
                        </button>
                        <button @click="sendQuickMessage('Are there free courses?')"
                            class="text-xs bg-blue-50 text-blue-600 px-3 py-1 rounded-full hover:bg-blue-100 transition">
                            Free courses?
                        </button>
                    </div>
        ...
        <div class="p-4 bg-white border-t border-gray-200">
            <form @submit.prevent="sendMessage" class="flex gap-2">
                ...
                <button type="submit" :disabled="loading || !messageInput"
